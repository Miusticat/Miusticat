# 💫 About Me:
Hi there! I'm Lady Johana Torres, a 20-year-old programmer from Colombia. I'm a Software Development tech grad and currently studying Software Engineering. I'm all about web and app development with a strong focus on UI/UX design.<br><br>I dive into both front-end and back-end work, using various languages and frameworks to create cool, user-friendly solutions. Check out my GitHub profile to see some of the projects I've worked on and the skills I've picked up along the way.<br><br>I’m always up for new challenges and love collaborating on exciting projects. Feel free to browse my work and drop me a message if you want to chat or work together!
